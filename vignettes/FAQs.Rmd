...
iSpy is under active development. If you need help, would like to contribute, or simply want to talk about the project with like-minded individuals, we have a number of open channels for communication.
...
## Where can I find examples of iSpy?

- See our [NGS Training tutorials using iSpy](getting-started.html)

## How to upgrate or remove older versions of iSpy or other containers?
