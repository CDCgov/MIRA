...
1. Open a terminal (Ubuntu if you installed WSL2 with [these instructions](getting-started.html), Terminal if you are using a Mac or Linux OS). Create a folder to store your sequence run data and change to that directory. This folder was previously called `FLU_SC2_SEQUENCING` in documentation predating September 2024:
