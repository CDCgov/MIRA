...
* In the Documents folder on your computer. Create a folder name "MIRA_NGS".

* In your "MIRA" folder, make a folder for your run. It is very helpful to name your runs with a consistent naming system, such as "YEAR-MONTH-DATE-FLOWCELL_ID", ie. 2022-11-13-ABC1234. 
