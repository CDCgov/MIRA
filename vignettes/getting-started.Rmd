...
6. Reopen Powershell and enter the following commands:
    ...
    ```
    If either of these commands errors out, from the Windows search bar, open `Turn Windows Features on or off` and make sure the following 4 features are checked off:
    -  Hyper-V
...
#### You are now ready to proceed to [MIRA Installation](https://cdcgov.github.io/MIRA/articles/mira-installation.html)
<hr>
<hr>
<br/><br/>
