...
vaccine strains [recommended by the World Health Organization for the nothern hemisphere 2022/23 
...
2. Unzip the file into the folder that MIRA accessess runs (ie. FLU_SC2_SEQUENCING).
