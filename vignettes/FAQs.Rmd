...
IRMAVISION is under active development. If you need help, would like to contribute, or simply want to talk about the project with like-minded individuals, we have a number of open channels for communication.

- To report bugs or file feature requests, use the [issue tracker on Github](https://github.com/nbx0/iSpy/issues).

- To contribute code submit a [pull request on Github](https://github.com/nbx0/iSpy/pulls).


## How to upgrate or remove older versions of IRMAVISION or other containers?

To upgrade IRMAVISION, spyne, IRMA or DAIS-Ribosome, you first need to remove your current version from your machine.
...
2. ```bash 
    ...
    ```
3. Install the new iSpy and spyne containers: [See NGS Training: Setting Up Containers](setting-up-containers.html)
